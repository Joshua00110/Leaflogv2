      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.quickActions}>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={openFertilizeModal}>
            ...
            {currentSeason !== 'winter' && fertilizeDuePlants.length > 0 && (
              <View style={styles.badge}>
          ...
          <View style={styles.modalBackground}>
            <View style={styles.modalContent}>
              ...
              {currentSeason === 'winter' ? (
                <View style={styles.seasonMessage}>
                  <Ionicons name="snow-outline" size={48} color="#94A3B8" />
                  <Text style={[styles.messageTitle, { marginTop: 10 }]}>Plants are dormant</Text>
                  <Text style={[styles.messageText, { marginTop: 5 }]}>
                    No fertilization needed during winter. Resume in spring.
                  </Text>
                </View>
              ) : (
                <>
